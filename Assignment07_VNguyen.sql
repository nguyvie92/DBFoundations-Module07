...
-- 2017-02-27,VNguyen,Created File
--**************************************************************************--
Begin Try
	Use Master;
...
Select ProductName, Format(I.InventoryDate,'MMMM, yyyy') as InventoryDate, [Count]
From vProducts as P
...
AS Select  top 10000 ProductName, Format(I.InventoryDate,'MMMM, yyyy') as InventoryDate, [Count]
From Products as P
Inner Join vInventories as I
on P.ProductID=I.ProductID
Order by ProductName, Month(InventoryDate), [count]
...
as Select top 10000 CategoryName, Format(I.InventoryDate,'MMMM, yyyy') as InventoryDate, sum([Count]) as Total
...
As Select top 10000 P.ProductName, Format(I.InventoryDate,'MMMM, yyyy') as InventoryDate, I.[Count] as InventoryCount, isnull(lag([count]) Over(Order By ProductName, Month(InventoryDate)),0) as PreviousMonthCount
From Products as P
Inner Join Inventories as I
on P.ProductID=I.ProductID
Order by ProductName, Month(I.InventoryDate), I.[Count]
go
...
Select top 10000 ProductName, InventoryDate, InventoryCount, PreviousMonthCount, Case 
...
Returns Table 
 As
   Return(Select ProductName, InventoryDate, InventoryCount, PreviousMonthCount, CountVsPreviousCountKPI from vProductInventoriesWithPreviousMonthCountsWithKPIs
